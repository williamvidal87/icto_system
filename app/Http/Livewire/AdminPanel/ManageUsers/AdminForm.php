...
class AdminForm extends Component
{
        ...
        try {
            if($this->UserID){
                ...
                $log_data = ([
                    ...
                    'activity'      =>  'This Admin ID. '.(177001477+$this->UserID).' is successfully Updated to Admin Table',
                ...
                $log_data = ([
                    'user_id'       =>  Auth::user()->id,
                    'activity'      =>  'This Admin ID. '.(177001477+$show['id']).' is successfully Store to Admin Table',
                    'created_at'    =>  date('Y-m-d H:i:s')
                    ]);
                UserActivityLogsDatabase::create($log_data);
    ...
    {
        return view('livewire.admin-panel.manage-users.admin-form');
    }
