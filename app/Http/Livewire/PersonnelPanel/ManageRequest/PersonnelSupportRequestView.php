...
class PersonnelSupportRequestView extends Component
{
    use WithFileUploads;
        ...
        try {
            if($this->ITSupportServicesRequestID){
                ...
                $log_data = ([
                    ...
                    'activity'      =>  'This Request No. '.'IR'.(6600+$this->ITSupportServicesRequestID).' is successfully Ongoing to IT Support Services Request',
    ...
    public function changepersonnel()
    {
        ...
        $this->emit('supportID',$this->ITSupportServicesRequestID,$this->WorkTicketID);
    }
    ...
    public function completed()
    {
        ...
        try {
            if($this->ITSupportServicesRequestID){
                ...
                $log_data = ([
                    'user_id'       =>  Auth::user()->id,
                    'activity'      =>  'This Request No. '.'IR'.(6600+$this->ITSupportServicesRequestID).' is successfully completed to IT Support Services Request',
                    'created_at'    =>  date('Y-m-d H:i:s')
                ]);
                UserActivityLogsDatabase::create($log_data);
                $show=WorkTicketDatabase::find($this->WorkTicketID)->update($this->data);
    ...
    {
        return view('livewire.personnel-panel.manage-request.personnel-support-request-view',[
