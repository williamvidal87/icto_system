...
<script type="text/javascript">
    ...
    window.livewire.on('openChangePersonnelModal', () => {

            $('#change_personnel').modal('show');
    });
...
window.livewire.on('closeChangePersonnelModal', () => {

        $('#change_personnel').modal('hide');
});
    ...
    // for update alert
    window.livewire.on('alert_change', () => {
        $(function() {
            var Toast = Swal.mixin({
            toast: true,
            position: 'top-end',
            ...
            Toast.fire({
            icon: 'info',
            title: 'Workticket Successfully Updated.'
            })
        });
    });
</script>
