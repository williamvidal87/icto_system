    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            @if(!empty($this->WorkTicketID))
                <label for="personnel_id">Work Ticket No:TK{{ 11000+$this->WorkTicketID }}</label>
            @endif
            <div class="row">
                <div class="col-sm-6">
        ...
        <!-- /.card-body -->
            ...
            <div class="modal-footer justify-content-between">
                ...
                <div>
                    ...
                    ?> type="button" class="btn btn-success" wire:click="approve"><i class="fas fa-thumbs-up"></i> Approve this request</button>
                    ...
                    @if($this->cancelButton==true&&$this->status_check==2)
                        <button type="button" class="btn btn-danger" wire:click="cancelWorkTicketBR({{$this->BorrowEquipmentRequestID}})"><i class="fas fa-times"></i> Cancel this Work Ticket</button>
                    @endif
                </div>
