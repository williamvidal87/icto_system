                            ...
                            <table id="BorrowEquipmentRequestTable" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Client</th>
                                        <th data-toggle="tooltip" data-placement="top" title="Equipment to borrow">Equipment</th>
                                        <th>Purpose</th>
                                        <th>Status</th>
                                        <th>Action</th>
                                    </tr>
                                    ...
                                    @foreach ($Client_Borrow_Equipment_Request_Database as $data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button  class="py-0 btn btn-sm btn-secondary" wire:click="openBorrowEquipmentRequestView({{$data->id}})"><i class="fas fa-eye"></i>Review</button>
                                            </td>
                                            @endif
                                        </tr>
                                    @endforeach
