            ...
            <div class="modal-footer justify-content-between">
                ...
                <div>
                    ...
                    @if($this->cancelButton==true&&$this->status_check==2)
                        <button type="button" class="btn btn-danger" wire:click="cancelWorkTicketIR({{$this->ITSupportServicesRequestID}})"><i class="fas fa-times"></i> Cancel this Work Ticket</button>
                    @endif
                </div>
