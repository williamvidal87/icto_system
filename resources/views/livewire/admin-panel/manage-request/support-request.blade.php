              ...
              <div class="card">
                ...
                <div class="card-body" style="font-size: 11pt">
                  <table id="ITSupportServicesRequestTable" class="table table-bordered table-striped">
                    ...
                    <tr>
                      <th>Request No.</th>
                      <th data-toggle="tooltip" data-placement="top" title="Person In-Charge">In-Charge</th>
                      <th>Client</th>
                      <th>Event Information</th>
                      <th>Schedule</th>
                      <th data-toggle="tooltip" data-placement="top" title="Service Needed">Services</th>
                      <th>Status</th>
                      <th>Action</th>
                    </tr>
                    </thead>
                    <tbody>
                      @foreach ($Client_ITSupportServices_Request_Database as $data)
                        <tr>
                          <td><u><a href="javascript: void(0)" wire:click="openSupportView({{$data->id}})">{{ "IR" }}{{ 6600+$data->id }}</a></u></td>
                        ...
                        @else
                          ...
                          <td>
                            <button  class="py-0 btn btn-sm btn-info" wire:click="editSupportRequest({{$data->id}})"><i class="fas fa-edit"></i>Edit</button> | 
                            <button  class="py-0 btn btn-sm btn-secondary" wire:click="openSupportView({{$data->id}})"><i class="fas fa-eye"></i>Review</button>
                          </td>
                        @endif
