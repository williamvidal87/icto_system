<div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div style="margin-left: 1rem">
                            <button style="width: 9rem" type="button" class="btn btn-block bg-gradient-primary"  wire:click="createTechnicalRequest"><i class="fa fa-plus-circle"></i> Add Request</button>
                        </div>
                        <!-- /.card-header -->
                                        ...
                                        <tr>
                                            ...
                                            @else
                                                ...
                                                <td>
                                                    ...
                                                    <button  class="py-0 btn btn-sm btn-danger" wire:click="deleteTechnicalRequest({{$data->id}})"><i class="fas fa-trash-alt"></i>Delete</button>
                                                </td>
                                            @endif
                                        </tr>
                                    @endforeach
    ...
    <div wire.ignore.self class="modal fade" id="TechnicalRequestView" role="dialog" aria-labelledby="TechnicalRequestView" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <livewire:client-panel.request-tech-services.technical-view />
            </div>
            <!-- /.modal-content -->
        </div>
        <!-- /.modal-dialog -->
